...
| 当前已建立原文关联的毛文标题数 | 52 |
| 当前已建立 `原文对应` 的 inspiration 文件数 | 282 |
| 顺序学习已连续覆盖范围 | 001—051 |
...
| 047 | 《向国民党的十点要求》 | [marxists.org](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19400201b.htm) | 已覆盖（顺序主线，6 个主题转译文件） |
