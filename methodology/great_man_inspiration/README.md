...
| 当前已建立原文关联的毛文标题数 | 52 |
| 当前已建立 `原文对应` 的 inspiration 文件数 | 269 |
| 顺序学习已连续覆盖范围 | 001—051 |
...
| 051 | 《抗日根据地的政权问题》 | [marxists.org](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19400306.htm) | 已覆盖（顺序主线，4 个主题转译文件） |
...
| 051 | 《抗日根据地的政权问题》 | [原文](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19400306.htm) | [TL](./inspiration_on_today_life/cooperation_and_organization/051-dont-call-it-shared-governance-if-public-affairs-are-still-run-by-a-few.md) | [SD](./inspiration_on_software_development/team_process_and_quality/051-dont-call-it-shared-engineering-governance-if-public-affairs-are-still-run-by-a-few.md) | [RC](./inspiration_on_running_a_company/strategy_and_execution/051-dont-call-it-shared-company-governance-if-public-affairs-are-still-run-by-a-few.md) | — | — | — | [ED](./inspiration_on_educational_undertakings/school_coordination_and_organization/051-dont-call-it-shared-school-governance-if-public-affairs-are-still-run-by-a-few.md) | 4 |
