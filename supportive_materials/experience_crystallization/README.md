...
This folder stores distilled practical experience accumulated while Hermes executes real research, note-taking, organization, and publishing tasks.

Suggested contents:
- repeatable workflows
- taxonomy lessons
- repository maintenance conventions
- sequencing and indexing discipline
- mistakes, pitfalls, and corrective heuristics
